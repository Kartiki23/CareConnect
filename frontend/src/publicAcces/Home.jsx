...
const specialties = [
  { name: 'Gynaecology', price: 499, image: '/images/gynae.png' },
  { name: 'Sexology', price: 499, image: '/images/sexology.png' },
  { name: 'General Physician', price: 399, image: '/images/physician.png' },
  { name: 'Dermatology', price: 449, image: '/images/derma.png' },
  { name: 'Psychiatry', price: 499, image: '/images/psychiatry.png' },
  { name: 'Stomach & Digestion', price: 399, image: '/images/digestion.png' },
  { name: 'Cardiology', price: 599, image: '/images/cardiology.png' },
  { name: 'Neurology', price: 599, image: '/images/neurology.png' },
  { name: 'Pediatrics', price: 399, image: '/images/pediatrics.png' },
  { name: 'Orthopedics', price: 499, image: '/images/ortho.png' },
  { name: 'ENT', price: 399, image: '/images/ent.png' },
  { name: 'Urology', price: 499, image: '/images/urology.png' },
  { name: 'Nephrology', price: 599, image: '/images/nephrology.png' },
  { name: 'Oncology', price: 699, image: '/images/oncology.png' },
  { name: 'Endocrinology', price: 499, image: '/images/endocrinology.png' },
  { name: 'Pulmonology', price: 499, image: '/images/pulmonology.png' },
  { name: 'Hematology', price: 499, image: '/images/hematology.png' },
  { name: 'Rheumatology', price: 499, image: '/images/rheumatology.png' },
  { name: 'Gastroenterology', price: 499, image: '/images/gastro.png' },
  { name: 'Ophthalmology', price: 499, image: '/images/ophthal.png' },
  { name: 'Dental', price: 399, image: '/images/dental.png' },
  { name: 'Psychology', price: 399, image: '/images/psychology.png' },
  { name: 'Homeopathy', price: 349, image: '/images/homeopathy.png' },
  { name: 'Ayurveda', price: 349, image: '/images/ayurveda.png' },
  { name: 'Nutrition', price: 399, image: '/images/nutrition.png' }
];
      ...
      <motion.section initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="bg-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <button
              onClick={() => setCurrentSpecialty((prev) => (prev - specialtySlideSize + specialties.length) % specialties.length)}
            ...
            <button
              onClick={() => setCurrentSpecialty((prev) => (prev + specialtySlideSize) % specialties.length)}
