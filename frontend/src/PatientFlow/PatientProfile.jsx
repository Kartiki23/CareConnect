...
const PatientProfile = () => {
    ...
    const fetchPatientProfile = async () => {
      try {
        ...
        let profilePhoto = data.patientPhoto
          ? `https://careconnect-1-xvl2.onrender.com/uploads/patients/${data.patientPhoto}`
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put("https://careconnect-1-xvl2.onrender.com/api/v1/user/updatePatientInfo", data, {
